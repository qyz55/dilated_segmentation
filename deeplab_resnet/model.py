...
class DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        (self.feed('bn2a_branch1', 
             ...
             .conv(1, 1, 64, 1, 1, biased=False, relu=False, name='res2b_branch2a')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2b_branch2a'))
        (self.feed('bn2b_branch2a')
             .conv(3, 3, 1, 1, 1, biased=False, relu=False, name='new_res2b_branch2b_c1')
             .exp(name='new_res2b_branch2b_e1'))
        (self.feed('bn2b_branch2a')
             .conv(3, 3, 1, 1, 1, biased=False, relu=False, name='new_res2b_branch2b_c2')
             .exp(name='new_res2b_branch2b_e2'))
        (self.feed('bn2b_branch2a')
             .conv(3, 3, 1, 1, 1, biased=False, relu=False, name='new_res2b_branch2b_c3')
             .exp(name='new_res2b_branch2b_e3'))
        (self.feed('new_res2b_branch2b_e1',
                   'new_res2b_branch2b_e2',
                   'new_res2b_branch2b_e3')
             .add(name='new_res2b_branch2b_cs'))
        (self.feed('new_res2b_branch2b_e1',
                   'new_res2b_branch2b_cs')
             .div(name='new_res2b_branch2b_d1'))
        (self.feed('new_res2b_branch2b_e2',
                   'new_res2b_branch2b_cs')
             .div(name='new_res2b_branch2b_d2'))
        (self.feed('new_res2b_branch2b_e3',
                   'new_res2b_branch2b_cs')
             .div(name='new_res2b_branch2b_d3'))


        (self.feed('bn2b_branch2a')
             .atrous_conv(3, 3, 64, 2, padding='SAME', biased=False, relu=False, name='res2b_branch2b'))
        (self.mfeed('new_res2b_branch2b_d1')
             .mult(name='new_res2b_branch2b_m1'))
             
        (self.feed('bn2b_branch2a')
             .atrous_conv(3, 3, 64, 3, padding='SAME', biased=False, relu=False, name='res2b_branch2b',reuse=True))
        (self.mfeed('new_res2b_branch2b_d2')
             .mult(name='new_res2b_branch2b_m2'))
             
        (self.feed('bn2b_branch2a')
             .atrous_conv(3, 3, 64, 5, padding='SAME', biased=False, relu=False, name='res2b_branch2b',reuse=True))
        (self.mfeed('new_res2b_branch2b_d3')
             .mult(name='new_res2b_branch2b_m3'))

        (self.feed('new_res2b_branch2b_m1',
                   'new_res2b_branch2b_m2',
                   'new_res2b_branch2b_m3')
             .add(name='new_res2b_branch2b_m')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2b_branch2b')
             .conv(1, 1, 256, 1, 1, biased=False, relu=False, name='res2b_branch2c')
             .batch_normalization(is_training=is_training, activation_fn=None, name='bn2b_branch2c'))
